...
public enum OrganizationTopic {
    ...
    WOHNUNG(List.of("Obdachlosigkeit", "keine Wohnung", "Nachbarschaftsstreit", "Kriminalität", "laute Gegend", "Ruhestörung")),
    EINSAMKEIT(List.of("Depression", "alleine sein", "keine Freunde", "soziale Isolation", "sozialer Rückzug", "keine Familie", "fehlender sozialer Rückhalt", "kein soziales Netzwerk")),
    KULTUR(List.of("Migrationshintergrund", "Staatsangehörigkeit", "Religion", "Migration")),
